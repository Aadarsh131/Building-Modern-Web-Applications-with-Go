...
func (repo *Repository) Home(w http.ResponseWriter, r *http.Request) {
	...
	// remote_ip := repo.App.Session.GetString(r.Context(),"remote_ip") //storing the session value here
	// fmt.Print(remote_ip)
}
...
func (repo *Repository) About(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Print(repo.App.Session.GetString(r.Context(),"remote_ip")) //why is it <nil>
}
